...
phonecatApp.controller('ModalInstanceCtrl', function($uibModalInstance, items) {
	var vm = this;
	// I want to get the vehicle data pass to populate the form
	// myModalContent.html
	vm.vehicle = items;
});

// Define the `PhoneListController` controller on the `phonecatApp` module
phonecatApp.controller("logparserConfigController",
		function PhoneListController($scope, $http, $uibModal) {
